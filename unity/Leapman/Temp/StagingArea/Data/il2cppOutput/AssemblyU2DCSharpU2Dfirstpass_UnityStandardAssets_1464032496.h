...
struct  LensflareStyle34_t1464032496 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(LensflareStyle34_t1464032496, ___value___1)); }
